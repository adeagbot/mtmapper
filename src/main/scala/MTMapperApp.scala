...
* @note The MT Mapper Utility
* @version 1.0
*/

object MTMapperApp extends App with LazyLogging{  
   ...
   */    
    ...
    def getMappingRow(year:String,message_type:String,
